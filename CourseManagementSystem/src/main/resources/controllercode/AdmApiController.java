...
import essusys.coursemanagementsystem.demos.web.api.adm.AdmApi;
...
public class AdmApiController implements AdmApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public AdmApiController(NativeWebRequest request) {
