...
import essusys.coursemanagementsystem.demos.web.api.classtable.ClasstableApi;
...
public class ClasstableApiController implements ClasstableApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public ClasstableApiController(NativeWebRequest request) {
