...
import essusys.coursemanagementsystem.demos.web.api.CourseIdSearchApi;
...
public class CourseIdSearchApiController implements CourseIdSearchApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public CourseIdSearchApiController(NativeWebRequest request) {
