...
import essusys.coursemanagementsystem.demos.web.api.CourseScoreApi;
...
public class CourseScoreApiController implements CourseScoreApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public CourseScoreApiController(NativeWebRequest request) {
