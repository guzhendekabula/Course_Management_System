...
import essusys.coursemanagementsystem.demos.web.api.EvaIdSearchApi;
...
public class EvaIdSearchApiController implements EvaIdSearchApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public EvaIdSearchApiController(NativeWebRequest request) {
