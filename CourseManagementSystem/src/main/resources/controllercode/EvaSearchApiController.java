...
import essusys.coursemanagementsystem.demos.web.api.EvaSearchApi;
...
public class EvaSearchApiController implements EvaSearchApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public EvaSearchApiController(NativeWebRequest request) {
