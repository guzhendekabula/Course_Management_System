...
import essusys.coursemanagementsystem.demos.web.api.personalpage.PersonalpageApi;
...
public class PersonalpageApiController implements PersonalpageApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public PersonalpageApiController(NativeWebRequest request) {
