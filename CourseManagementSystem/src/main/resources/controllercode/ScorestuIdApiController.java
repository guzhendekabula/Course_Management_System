...
import essusys.coursemanagementsystem.demos.web.api.ScorestuIdApi;
...
public class ScorestuIdApiController implements ScorestuIdApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public ScorestuIdApiController(NativeWebRequest request) {
