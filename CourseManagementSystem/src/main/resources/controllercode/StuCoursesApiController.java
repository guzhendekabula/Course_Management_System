...
import essusys.coursemanagementsystem.demos.web.api.stu.StuCoursesApi;
...
public class StuCoursesApiController implements StuCoursesApi {

    private final NativeWebRequest request;

    @org.springframework.beans.factory.annotation.Autowired
    public StuCoursesApiController(NativeWebRequest request) {
